...
export async function GET(request: NextRequest) {
  ...
  const url = `https://apis.data.go.kr/B551011/KorService2/searchKeyword2?serviceKey=${serviceKey}&keyword=${encodeURIComponent(keyword)}&_type=json&arrange=A&numOfRows=10&MobileOS=ETC&MobileApp=AppTest`;
